...
describe('UserEntity', () => {
    ...
    describe('create', () => {
        it('should create a UserEntity with current timestamp', () => {
            ...
            const userEntity = UserEntity_1.UserEntity.create(validUserData);
    ...
    describe('validate', () => {
        ...
        it('should return false for invalid email', () => {
            ...
            const userEntity = UserEntity_1.UserEntity.create(invalidData);
            expect(userEntity.validate()).toBe(false);
        });
        it('should return false for short number_id', () => {
            const invalidData = Object.assign(Object.assign({}, validUserData), { number_id: '123' });
            const userEntity = UserEntity_1.UserEntity.create(invalidData);
            expect(userEntity.validate()).toBe(false);
        });
        it('should return false for empty number_id', () => {
            const invalidData = Object.assign(Object.assign({}, validUserData), { number_id: '' });
            const userEntity = UserEntity_1.UserEntity.create(invalidData);
            expect(userEntity.validate()).toBe(false);
        });
        it('should return false for missing name', () => {
            const invalidData = Object.assign(Object.assign({}, validUserData), { name: '' });
            const userEntity = UserEntity_1.UserEntity.create(invalidData);
            expect(userEntity.validate()).toBe(false);
        });
        it('should return false for missing last_name', () => {
            const invalidData = Object.assign(Object.assign({}, validUserData), { last_name: '' });
            const userEntity = UserEntity_1.UserEntity.create(invalidData);
            expect(userEntity.validate()).toBe(false);
        });
        it('should return false for invalid cellphone', () => {
            const invalidData = Object.assign(Object.assign({}, validUserData), { cellphone: 'invalid-phone' });
            const userEntity = UserEntity_1.UserEntity.create(invalidData);
            expect(userEntity.validate()).toBe(false);
        });
        it('should return false for short password', () => {
            const invalidData = Object.assign(Object.assign({}, validUserData), { password: '123' });
            const userEntity = UserEntity_1.UserEntity.create(invalidData);
            expect(userEntity.validate()).toBe(false);
        });
        it('should return false for empty password', () => {
            const invalidData = Object.assign(Object.assign({}, validUserData), { password: '' });
            const userEntity = UserEntity_1.UserEntity.create(invalidData);
            expect(userEntity.validate()).toBe(false);
        });
        it('should accept valid international phone numbers', () => {
            ...
            validPhones.forEach(phone => {
                const userData = Object.assign(Object.assign({}, validUserData), { cellphone: phone });
